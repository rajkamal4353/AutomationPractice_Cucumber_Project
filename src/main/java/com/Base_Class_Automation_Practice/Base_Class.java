package com.Base_Class_Automation_Practice;
...
// -----------------Screenshot-----------------
	...
	public static void screenshot(String type) throws Throwable {
		...
		File dest = new File("C:\\Users\\M.Rajkamal\\apache-maven-3.8.3\\apache-maven-3.8.3\\bin\\AutomationPractice_Cucumber\\Screenshot\\"+type+".png");
