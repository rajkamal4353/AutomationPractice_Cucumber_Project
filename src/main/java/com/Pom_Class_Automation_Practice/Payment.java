package com.Pom_Class_Automation_Practice;
...
public class Payment {
  ...
  public WebDriver driver;        // ---> Null Driver
	...
	@FindBy(xpath = "//a[@class='bankwire']")        //   "//a[@title='Pay by bank wire']"
	private WebElement bank_wire;                           
	
	@FindBy(xpath = "//span[text()='I confirm my order']")   //  "//span[normalize-space()='I confirm my order']"
